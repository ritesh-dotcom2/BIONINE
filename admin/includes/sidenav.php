        ...
        <ul class="pcoded-item pcoded-left-item">
                    ...
                    <li class=" ">
                        <a href="make_report.php">
                            ...
                            <span class="pcoded-mtext" data-i18n="nav.basic-components.alert"
                                style="font-weight: 400;">Generate Report</span>
                            <span class="pcoded-mcaret"></span>
                        </a>
                    </li>
                </ul>
                ...
                <ul class="pcoded-submenu">
                    <li class=" ">
                        <a href="add_cata.php">
                            ...
                            <span class="pcoded-mtext" data-i18n="nav.basic-components.alert"
                                style="font-weight: 400;">Add Category</span>
                            <span class="pcoded-mcaret"></span>
                        </a>
                    </li>
                    <li class=" ">
                        <a href="manage_cata.php">
                            ...
                            <span class="pcoded-mtext" data-i18n="nav.basic-components.breadcrumbs"
                                style="font-weight: 400;">Manage Category</span>
                            <span class="pcoded-mcaret"></span>
                        </a>
                    </li>
                </ul>
                ...
                <ul class="pcoded-submenu">
                    <li class=" ">
                        <a href="add_product.php">
                            <span class="pcoded-micon"><i class=" ti-bag"></i></span>
                            <span class="pcoded-mtext" data-i18n="nav.basic-components.alert"
                                style="font-weight: 400;">Add Product</span>
                            <span class="pcoded-mcaret"></span>
                        </a>
                    </li>
                    <li class=" ">
                        <a href="manage_product.php">
                            <span class="pcoded-micon"><i class=" ti-bag"></i></span>
                            <span class="pcoded-mtext" data-i18n="nav.basic-components.breadcrumbs"
                                style="font-weight: 400;">Manage Products</span>
                            <span class="pcoded-mcaret"></span>
                        </a>
                    </li>
                </ul>
            ...
            <li class="pcoded-hasmenu">
                <a href="javascript:void(0)">
                    ...
                    <span class="pcoded-mtext" data-i18n="nav.basic-components.main">Check Orders</span>
                    <span class="pcoded-mcaret"></span>
                </a>
                <ul class="pcoded-submenu">
                    <li class="">
                        <a href="add_order.php">
                            <span class="pcoded-micon"><i class=" ti-truck"></i></span>
                            <span class="pcoded-mtext" data-i18n="nav.basic-components.alert"
                                style="font-weight: 400;">Add Order</span>
                            <span class="pcoded-mcaret"></span>
                        </a>
                    </li>
                </ul>
                <ul class="pcoded-submenu">
                    <li class="">
                        <a href="manage_order.php">
                            <span class="pcoded-micon"><i class=" ti-truck"></i></span>
                            <span class="pcoded-mtext" data-i18n="nav.basic-components.alert"
                                style="font-weight: 400;">Manage Orders</span>
                            <span class="pcoded-mcaret"></span>
                        </a>
                    </li>
                </ul>
            ...
            <li class="pcoded-hasmenu">
                <a href="javascript:void(0)">
                    ...
                    <span class="pcoded-mtext" data-i18n="nav.basic-components.main">Coupons</span>
                    <span class="pcoded-mcaret"></span>
                </a>
                <ul class="pcoded-submenu">
                    <li class=" ">
                        <a href="add_coupon.php">
                            <span class="pcoded-micon"><i class=" ti-envelope"></i></span>
                            <span class="pcoded-mtext" data-i18n="nav.basic-components.alert"
                                style="font-weight: 400;">Add Coupon</span>
                            <span class="pcoded-mcaret"></span>
                        </a>
                    </li>
                    <li class=" ">
                        <a href="manage_coupon.php">
                            <span class="pcoded-micon"><i class=" ti-envelope"></i></span>
                            <span class="pcoded-mtext" data-i18n="nav.basic-components.breadcrumbs"
                                style="font-weight: 400;">Manage Coupons</span>
                            <span class="pcoded-mcaret"></span>
                        </a>
                    </li>
                </ul>
                    ...
                    <ul class="pcoded-submenu">
                        <li class=" ">
                            <a href="add_admin_user.php">
                                <span class="pcoded-micon"><i class="ti-user"></i></span>
                                <span class="pcoded-mtext" data-i18n="nav.basic-components.alert"
                                    style="font-weight: 400;">Add User</span>
                                <span class="pcoded-mcaret"></span>
                            </a>
                        </li>
                    </ul>
                    <ul class="pcoded-submenu">
                        <li class=" ">
                            <a href="manage_user.php">
                                <span class="pcoded-micon"><i class="ti-user"></i></span>
                                <span class="pcoded-mtext" data-i18n="nav.basic-components.alert"
                                    style="font-weight: 400;">Manage User</span>
                                <span class="pcoded-mcaret"></span>
                            </a>
                        </li>
                ...
                <ul class="pcoded-submenu">
                    <li class=" ">
                        <a href="customer_feedback.php">
                            <span class="pcoded-micon"><i class=" ti-receipt"></i></span>
                            <span class="pcoded-mtext" data-i18n="nav.basic-components.alert"
                                style="font-weight: 400;">Customer Feedback</span>
                            <span class="pcoded-mcaret"></span>
                        </a>
                    </li>
                </ul>
                ...
                <ul class="pcoded-submenu">
                    <li class=" ">
                        <a href="add_links.php">
                            <span class="pcoded-micon"><i class=" ti-id-badge"></i></span>
                            <span class="pcoded-mtext" data-i18n="nav.basic-components.alert"
                                style="font-weight: 400;">Social Media</span>
                            <span class="pcoded-mcaret"></span>
                        </a>
                    </li>
                    <li class=" ">
                        <a href="add_logo.php">
                            <span class="pcoded-micon"><i class=" ti-id-badge"></i></span>
                            <span class="pcoded-mtext" data-i18n="nav.basic-components.breadcrumbs"
                                style="font-weight: 400;">Add Logo</span>
                            <span class="pcoded-mcaret"></span>
                        </a>
                    </li>
                </ul>
                ...
                <ul class="pcoded-submenu">
                    <li class=" ">
                        <a href="manage_slider.php">
                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                            <span class="pcoded-mtext" data-i18n="nav.basic-components.alert"
                                style="font-weight: 400;">Manage Slider</span>
                            <span class="pcoded-mcaret"></span>
                        </a>
                    </li>
                </ul>
            ...
            <li class="pcoded-submenu">
                <a href="../index.php" target="_blank">
                    <span class="pcoded-micon"><i class="ti-microsoft"></i></span>
