...
<body class="biolife-body">
        ...
        <div class="hero-product">
            <div class="hero-section">
                <div class="hero-content">
                    <h1>🌿 Bionine: Elevate Your Beauty Naturally 🌿 </h1>
                </div>
            </div>
        </div>
    </div>
    <div class="hero-product-mob">
        <div class="hero-product">
            <img src="admin/uploads/banner-mob-1.png" alt="">
        </div>
    </div>
    <!-- Page Contain -->
    <div class="page-contain my-5 py-5 ">
        ...
        <div id="main-content" class="main-content">
            ...
            <!-- Product -->
            <div class="container">
                <!-- <h3 style="font-size:30px; font-weight:700; text-align:center; margin-top:20px; margin-bottom:10px ">All
                    Products</h3> -->
