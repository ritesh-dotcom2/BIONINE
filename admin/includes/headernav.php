    ...
    <div class="navbar-wrapper">
        <div class="navbar-logo">
            ...
            <a href="index.php">
                ...
                <img class="img-fluid" src="uploads/bioninee.png" alt="biolife logo" width="150" height="120">
            </a>
        ...
        <div class="navbar-container container-fluid">
            ...
            <ul class="nav-right">
                ...
                <li class="user-profile header-notification">
                    <a href="#!">
                        <img src="assets/images/userp.png" class="img-radius" alt="User-Profile-Image">
                        <span>
