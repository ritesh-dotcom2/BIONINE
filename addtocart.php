                                            ...
                                            foreach ($_SESSION['cart'] as $key => $value) {
                                                ...
                                                <tr class="cart_item">
                                                    <td class="product-thumbnail" data-title="Product Name">
                                                        <a class="prd-thumb"
                                                            href="single_product.php?status=singleproduct&&id=<?php echo $value['pdt_id'] ?>">
                                                            <figure><img width="113" height="113"
                                                                    src="admin/uploads/<?php echo $value['pdt_img'] ?>"
                                                                    alt="shipping cart"></figure>
                                                        </a>
                                                        <a class="prd-name"
                                                            href="single_product.php?status=singleproduct&&id=<?php echo $value['pdt_id'] ?>">
                                                            <?php echo $value['pdt_name'] ?>
                                                        </a>
                                                    ...
                                                    <td class="product-price" data-title="Price">
                                                        ...
                                                        <div class="prod-qua">
                                                            <input type="number" value="1" name="quantity" class="quantity"
                                                                style="width: 65px;" id="quantity" min="1" max="10"
                                                                onchange="subtotal(), totalOfAll()">
                                                    ...
                                                    <td class="product-quantity" data-title="Quantity">
                                                        <form action="" method="POST">
                                                            ...
                                                            <input type="hidden" value="<?php echo $value['pdt_name'] ?>"
                                                                name="remove_pdt_name">
                                                            <input class="btn btn-warning" type="submit" value="Remove Product"
                                                                name="remove_product">
                                                        </form>
                                                    </td>
                            ...
                            <div class="shpcart-subtotal-block">
                                <div class="subtotal-line ">
                                    <b class="stt-name">Subtotal <span class="sub">(
                                            <?php echo $total_product . 'Items' ?>)
                                        </span></b>
                                    <span class="stt-price">Rs.
                                        <?php echo $subtotal; ?>
                                    </span>
                                </div>
                                <!-- <div class="subtotal-line">
