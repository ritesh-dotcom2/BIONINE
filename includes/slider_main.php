...
<section class="desk-div" >
<div id="carouselExampleInterval" class="carousel slide carousel-fade" data-bs-ride="carousel">
    <div class="carousel-inner">
        <div class="carousel-item active" data-bs-interval="2000">
            <img src="admin/uploads/04.png" class="d-block w-100" alt="...">
        </div>
        <div class="carousel-item" data-bs-interval="2000">
            <img src="admin/uploads/03.png" class="d-block w-100" alt="...">
        </div>
        <div class="carousel-item" data-bs-interval="2000">
            <img src="admin/uploads/05.png" class="d-block w-100" alt="...">
        </div>
    </div>
...
<section class="mob-div" >
<div id="carouselExampleInterval-1" class="carousel slide carousel-fade" data-bs-ride="carousel">
    <div class="carousel-inner">
        <div class="carousel-item active" data-bs-interval="2000">
            <img src="admin/uploads/mob-banner-1.png" class="d-block w-100" alt="...">
        </div>
        <div class="carousel-item" data-bs-interval="2000">
            <img src="admin/uploads/mob-banner-2.png" class="d-block w-100" alt="...">
        </div>
        <div class="carousel-item" data-bs-interval="2000">
            <img src="admin/uploads/mob-banner-3.png" class="d-block w-100" alt="...">
        </div>
    </div>
    <button class="carousel-control-prev" type="button" data-bs-target="#carouselExampleInterval-1" data-bs-slide="prev">
        <span class="carousel-control-prev-icon" aria-hidden="true"></span>
        <span class="visually-hidden">Previous</span>
    </button>
    <button class="carousel-control-next" type="button" data-bs-target="#carouselExampleInterval-1" data-bs-slide="next">
        <span class="carousel-control-next-icon" aria-hidden="true"></span>
        <span class="visually-hidden">Next</span>
    </button>
</div>
...
<!---------- Import Spare Parts Brands We Use ----------->

<div class="choose-product-section mt-5">
    <div class="container">
        <div class="section-title text-center mb-4">
            <h1>"Discover the ideal skincare routine!"</h1>
        </div>
        <div class="row gy-4 justify-content-center mt-3">
            <div class="col-lg-4 col-md-6">
                <div class="choose-product-card hover-img style-2" data-aos="fade-up" data-aos-duration="2000">
                    <a href="all_product.php">
                        <img src="admin/uploads/10.png" alt>
                    </a>
                </div>
            </div>
            <div class="col-lg-4 col-md-6">
                <div class="choose-product-card hover-img style-2" data-aos="fade-down" data-aos-duration="2000">
                    <a href="all_product.php">
                        <img src="admin/uploads/09.png" alt>
                    </a>
                </div>
            </div>
            <div class="col-lg-4 col-md-6">
                <div class="choose-product-card hover-img style-2 " data-aos="fade-up" data-aos-duration="2000">
                    <a href="all_product.php">
                        <img src="admin/uploads/11.png" alt>
                    </a>
                </div>
            </div>
        </div>
...
<!-- Deal Section -->
<section class="deal-section my-5 pt-5" style="background-image: url(admin/uploads/16.png);background-position: right;">
    <div class="top-pattern-layer" style="background-image: url(admin/uploads/pattern-1.png)"></div>
    <div class="bottom-pattern-layer" style="background-image: url(admin/uploads/pattern-2.png)"></div>
    <div class="container-fluid mt-5" data-aos="zoom-in" data-aos-duration="2000">
        <div class="content-box" style="background-image: url(images/resource/en.jpg)">
            <div class="box-inner">
                <div class="sec-title light centered">
                    <div class="title">30% Off For Charcoal Face Wash</div>
                    <h2>Big Deals of the Week</h2>
                    <div class="text">
                        Once a week we send out an email with the latest discounts,
                        <br />
                        new arrivals, special sales, coupons and more.
                    </div>
                </div>

                <div class="email-form">
                    <div class="email-title">To Get New Of Our Deals</div>
                    <form method="post" action="https://preview.designtone.xyz/html/foodily/contact.html">
