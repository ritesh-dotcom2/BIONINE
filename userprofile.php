    ...
    <div class="page-contain">
        ...
        <div id="main-content" class="main-content pt-5 mt-5">
            <div class="container">
                <div class="row">
                    <div class="col-md-10">
                        <h2 style="text-center">Hello <?php
                                    if (isset($username)) {
                                        echo strtoupper($username);
                                    }
                                    ?>
                        </h2>                   
                        <h2 class="btn btn-danger"><a href="?logout=logout">Logout</a></h2>
                    </div>
                    <div class="col-md-9">
                        <h2 class="text-center text-dark"><b>Cart Summary</b></h2>
                    ...
                    <div class="col-md-3">
                        <div class="shpcart-subtotal-block">
                            ...
                            <div class="subtotal-line ">
                                <p class="stt-name" style="font-weight: normal;">Use Coupon</p>
                                <br>
                                <input type="text" name="cupon" id="cupon" class="form-control" style="width:40%; padding:5px; display:inline">
