                            ...
                            <div class="auth-box">
                                ...
                                <div class="row m-t-25 text-left">
                                    ...
                                    <div class="col-sm-5 col-xs-12 forgot-phone text-right">
                                        <a href="admin_password_recover.php" class="text-right f-w-400 text-inverse">
                                            Forgot Your Password?</a>
                                    </div>
                                </div>
                                <div class="row m-t-30">
                                    <div class="col-md-12">
                                        <input type="submit" name="admin_btn"
                                            class="btn btn-primary btn-md btn-block waves-effect text-center m-b-5"
                                            value="Submit">
                                    </div>
                                </div>
                                <hr />
                                ...
                                <div class="row">
                                    <div class="col-md-10">
                                        ...
                                        <p class="text-inverse text-left"><b>Your BIONINE</b></p>
                                    </div>
                                    <div class="col-md-2">
